...
parser.add_argument("dec_fact", type=float, help="fattore di decadimento")
parser.add_argument("min_fract", type=int, help="frazione minima (es 8 -> un ottavo della frequenza totale)")
parser.add_argument("max_fract", type=int, help="frazione massima (es 4 -> un quarto della frequenza totale)")

args = parser.parse_args()

dec_fact = float(args.dec_fact)
min_fract = float(args.min_fract)
max_fract = float(args.max_fract)
